...
#  Settings
# ==========================================================================
env.project_name = 'visitors_entry_system'
...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.visitors_entry_system.com']
    env.dotenv_path = '/home/ubuntu/dev/visitors_entry_system/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.visitors_entry_system.com']
    env.dotenv_path = '/home/ubuntu/qa/visitors_entry_system/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.visitors_entry_system.com']
    env.dotenv_path = '/home/ubuntu/prod/visitors_entry_system/.env'
    env.config_setter = fab.run
