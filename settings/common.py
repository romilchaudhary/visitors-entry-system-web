"""Django settings for Visitors Entry System project.
...
APPS_DIR = ROOT_DIR.path('visitors_entry_system')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'visitors_entry_system.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'visitors_entry_system.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'visitors_entry_system.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='Visitors Entry System')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='Visitors Entry System')
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'visitors_entry_system.urls'
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='Visitors Entry System <support@visitors_entry_system.com>')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[Visitors Entry System] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/visitors_entry_system'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'visitors_entry_system.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'visitors_entry_system.base.views.csrf_failure'
...
def get_release():
    import visitors_entry_system
    import os
    import raven
    release = visitors_entry_system.__version__
    try:
